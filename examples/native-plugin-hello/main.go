...
// definition returns the plugin's runtime behavior. Identity and
// compatibility live in the signed manifest.json shipped with the binary;
// this struct is only the behavioral contract the host needs to validate
// config and route events.
