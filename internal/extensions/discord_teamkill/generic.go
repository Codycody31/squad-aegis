...
// DiscordTeamkillExtension sends chat messages to Discord
type DiscordTeamkillExtension struct {
...
func Define() extension_manager.ExtensionDefinition {
	return extension_manager.ExtensionDefinition{
		...
		Description:            "will send a copy of teamkills made in game to a Discord channel.",
		Version:                "1.0.0",
		Author:                 "Squad Aegis",
		...
		EventHandlers: []extension_manager.EventHandler{
			{
				...
				Name:        "TEAMKILL",
				Description: "Logs teamkills to Discord.",
				Handler: func(e extension_manager.Extension, data interface{}) error {
					return e.(*DiscordTeamkillExtension).handleTeamkill(data)
				},
			},
		},
		CreateInstance: func() extension_manager.Extension {
			return &DiscordTeamkillExtension{}
		},
	}
}

// Initialize initializes the extension with its configuration and dependencies
func (e *DiscordTeamkillExtension) Initialize(config map[string]interface{}, deps *extension_manager.Dependencies) error {
...
func (e *DiscordTeamkillExtension) Shutdown() error {
