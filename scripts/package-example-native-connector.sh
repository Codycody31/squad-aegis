...
validate_json_string "CONNECTOR_ID" "${CONNECTOR_ID}"
validate_json_string "CONNECTOR_NAME" "${CONNECTOR_NAME}"
validate_json_string "CONNECTOR_DESCRIPTION" "${CONNECTOR_DESCRIPTION}"
validate_json_string "CONNECTOR_VERSION" "${CONNECTOR_VERSION}"
validate_json_string "CONNECTOR_AUTHOR" "${CONNECTOR_AUTHOR}"
