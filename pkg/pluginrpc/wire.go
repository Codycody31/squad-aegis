...
// carries only the runtime/behavioral surface; identity and compatibility
// live in the signed manifest.json. The host cross-checks PluginID against
// manifest.plugin_id during load and merges the two halves.
